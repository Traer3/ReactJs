...
const TestPoster = ({posterStates, updatePosterState, setPosterStates, setUpdatePosterState}) => {  
    ...
    const handleStateChange = (key) =>{
       ...
       setPosterStates(posterStates);
       setUpdatePosterState(updatePosterState);
        ...
        <div>
            ...
            <div >
                <SummaryWindow 
                    ...
                    filePath={logicAND} 
                    showSummaryWindow={posterStates.logicAND}                   //получить это 
                    setShowSummaryWindow ={()=> handleStateChange("logicAND")}  //получить это 
                    keyName={"logicAND"}                                        
                />
                <TerminalWindow 
